...
Unsupported kwargs for itertools.product
...
Expected kwargs: 'repeat', but got {','.join(set(kwargs.keys()) - {'repeat'})}
...
[Click here to add Additional Info](https://github.com/meta-pytorch/compile-graph-break-site/edit/main/docs/gb/gb0268.md)
